...
class StockMarketEast(StockMarketTemplate):
    ...
    def get_market(self, stock_code: str = '000001', start_date='1990-01-01', k_type=1, adjust_type: int = 1):
        ...
        params = {"fields1": "f1,f2,f3,f4,f5,f6",
                  ...
                  "klt": f"10{k_type}", "fqt": adjust_type,
                  "secid": f"{se_cid}.{stock_code}",
                  "beg": start_date, "end": '20240722',
                  "_": "1623766962675",
                  }
        # 2. 请求url
        ...
        if not (data_json["data"] and data_json["data"]["klines"]):
            return pd.DataFrame()
        data = [item.split(",") for item in data_json["data"]["klines"]]
...
if __name__ == '__main__':
    print(StockMarketEast().get_market(stock_code='000001', start_date='2021-01-01', k_type=1))
    print(StockMarketEast().get_market_min(stock_code='000001'))
    print(StockMarketEast().get_market_bar(stock_code='000001'))
