...
class BondMarketTemplate(object):
    ...
    _MARKET_COLUMNS = ['bond_code', 'bond_name', 'open', 'close', 'volume', 'high', 'low', 'amount',
                       'change', 'change_pct', 'pre_close']
    _MARKET_MIN_COLUMNS = ['bond_code', 'trade_time', 'price', 'change', 'change_pct', 'volume', 'avg_price', 'amount']
    _MARKET_FIVE_COLUMNS = ['bond_code', 'bond_name', 's5', 'sv5', 's4', 'sv4', 's3', 'sv3', 's2', 'sv2', 's1', 'sv1',
                            'b1', 'bv1', 'b2', 'bv2', 'b3', 'bv3', 'b4', 'bv4', 'b5', 'bv5']
    _MARKET_BAR_COLUMNS = ['bond_code', 'trade_time', 'price', 'volume', 'bs_type']
